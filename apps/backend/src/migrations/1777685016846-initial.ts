...
export class Initial1777685016846 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      `CREATE TABLE "product_translation" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "languageCode" character varying NOT NULL, "name" character varying NOT NULL, "slug" character varying NOT NULL, "description" text NOT NULL, "id" SERIAL NOT NULL, "baseId" integer, "customFieldsMaterialcomposition" character varying(255), "customFieldsCareinstructions" text, "customFieldsSustainabilitynotes" text, "customFieldsManufacturerinfo" text, "customFieldsWarnings" text, CONSTRAINT "PK_62d00fbc92e7a495701d6fee9d5" PRIMARY KEY ("id"))`,
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "product" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "enabled" boolean NOT NULL DEFAULT true, "id" SERIAL NOT NULL, "featuredAssetId" integer, "customFieldsResponsiblepersonid" integer, "customFieldsActivity" text NOT NULL DEFAULT '[]', "customFieldsTraceabilitycode" character varying(255), CONSTRAINT "UQ_59604ef41d5c6d8fbd96b78423d" UNIQUE ("customFieldsTraceabilitycode"), CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`,
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "customer" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "title" character varying, "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "phoneNumber" character varying, "emailAddress" character varying NOT NULL, "id" SERIAL NOT NULL, "userId" integer, "customFieldsMarketingoptin" boolean DEFAULT false, "customFieldsMarketingoptinat" TIMESTAMP(6), "customFieldsPreferredactivity" character varying(255), CONSTRAINT "REL_3f62b42ed23958b120c235f74d" UNIQUE ("userId"), CONSTRAINT "PK_a7a13f4cacb744524e44dfdad32" PRIMARY KEY ("id"))`,
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "responsible_person" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, "email" character varying NOT NULL, "address" text NOT NULL, "id" SERIAL NOT NULL, CONSTRAINT "PK_2db12b7b5c4977a3d686ef9fb6a" PRIMARY KEY ("id"))`,
      undefined,
    );
    await queryRunner.query(
      `CREATE TABLE "newsletter_subscription" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "email" character varying NOT NULL, "locale" character varying NOT NULL DEFAULT 'en', "status" character varying(16) NOT NULL, "verifiedAt" TIMESTAMP, "id" SERIAL NOT NULL, CONSTRAINT "PK_0e447c9eba4ae7ebdbaef097bc3" PRIMARY KEY ("id"))`,
      undefined,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_7c23b6c409a2f566ea2c2dc6f7" ON "newsletter_subscription" ("email") `,
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "product" ADD CONSTRAINT "FK_c2f754354838189c5d34c5ebf80" FOREIGN KEY ("customFieldsResponsiblepersonid") REFERENCES "responsible_person"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
      undefined,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      `ALTER TABLE "product" DROP CONSTRAINT "FK_c2f754354838189c5d34c5ebf80"`,
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(`DROP INDEX "public"."IDX_7c23b6c409a2f566ea2c2dc6f7"`, undefined);
    await queryRunner.query(`DROP TABLE "newsletter_subscription"`, undefined);
    await queryRunner.query(`DROP TABLE "responsible_person"`, undefined);
